...
def register_highway_envs():
    ...
    register(
        id='ramp-merge-v0',
        entry_point='projects.lampilot.envs:RampMergeEnv',
    )

    # DTHighway env
    register(
        id='dt-highway-v0',
        entry_point='projects.lampilot.envs:DTHighwayEnv',
    )

    # DTIntersection env
    register(
        id='dt-intersection-v0',
        entry_point='projects.lampilot.envs:DTIntersectionEnv',
    )


# Register all environments when the module is imported
